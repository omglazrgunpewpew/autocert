...
function Test-SystemConfiguration
{
    ...
    Write-Information -MessageData "Running configuration validation..." -InformationAction Continue
    ...
    try
    {
        ...
        # Display results
        Write-Information -MessageData "`nConfiguration Validation Results:" -InformationAction Continue
...
function Show-Help
{
    ...
    Write-Information -MessageData "• DNS provider detection with 10+ supported providers" -InformationAction Continue
...
function Test-SystemHealth
{
    ...
    Write-Host -Object "Issues: $($healthIssues.Count) critical, $($healthWarnings.Count) warnings" -ForegroundColor White
